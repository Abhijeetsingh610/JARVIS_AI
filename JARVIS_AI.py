...
def wishMe():
    ...
    if hour>=6 and hour<12:
        ...
        speak("Good Afternoon Abhi!")

    elif hour>=18 and hour<24:
        speak("Good Evening Abhi!")

    else:
        speak("Good Night Abhi!")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        elif 'open epic game 'in query or 'open epic game launcher' in query:
           speak('Opening epic game launcher.')
           engine.runAndWait()
           programName ="D:\Epic Games\Launcher\Portal\Binaries\Win32\EpicGamesLauncher.exe"
           subprocess.Popen([programName])

        elif 'close epic game launcher' in query or 'close epic game 'in query:
            speak("ok sir, closing epic game launcher")
